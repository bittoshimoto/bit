...
"""Example logging Bit Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bitd
...
def main(bitd_path):
    ...
    b = BPF(text=program, usdt_contexts=[bitd_with_usdts])
