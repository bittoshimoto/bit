# Bootstrappable Bit Core Builds

This directory contains the files necessary to perform bootstrappable Bit
Core builds.
...
To build Bit Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/bit-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/bit-core/guix.sigs).
