...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of bit node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple bit ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple bit ports', file=sys.stderr)
