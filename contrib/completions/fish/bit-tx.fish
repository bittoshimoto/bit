...
# Extract options
function __fish_bit_tx_get_options
...
# Extract commands
function __fish_bit_tx_get_commands
...
complete \
    --command bit-tx \
    --condition "not __fish_bit_seen_cmd (__fish_bit_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bit_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bit-tx \
    --arguments "(__fish_bit_tx_get_commands)" \
    --no-files
