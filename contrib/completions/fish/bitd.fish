...
complete --command bitd --no-files

# Extract options
function __fish_bitd_get_options
...
complete \
    --command bitd \
    --arguments "(__fish_bitd_get_options --nofiles)"
