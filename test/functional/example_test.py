...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitTestFramework
    pass


class ExampleTest(BitTestFramework):
    # Each functional test is a subclass of the BitTestFramework class.
    ...
    def custom_method(self):
        ...
        BitTestFramework class so other tests can use it."""
