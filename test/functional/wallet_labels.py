...
class WalletLabelsTest(BitTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 Bits
        ...
        if self.options.descriptors:
            ...
            for l in BECH32_INVALID:
                ...
                assert_raises_rpc_error(
                    -5,
                    "Address is not valid" if self.options.descriptors else "Invalid Bit address or script",
