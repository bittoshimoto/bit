...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/bit/bit/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(BitTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our bitd node")
