...
class KeyPoolTest(BitTestFramework):
    ...
    def run_test(self):
        ...
        # Using a fee rate (10 tos / byte) well above the minimum relay rate
        # creating a 5,000 tos transaction with change should not be possible
        ...
        # creating a 10,000 tos transaction without change, with a manual input, should still be possible
        ...
        # creating a 10,000 tos transaction without change should still be possible
        ...
        # creating a 10,000 tos transaction with a manual change address should be possible
