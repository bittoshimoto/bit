...
Verify that a bitd node can use an external signer command.
...
class RPCSignerTest(BitTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitd with -signer=<cmd>',
