...
class BumpFeeTest(BitTestFramework):
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by Bit to serialize ECDSA signatures means that signatures can have a
...
def test_watchonly_psbt(self, peer_node, rbf_node, dest_address):
    ...
    # Ensure the payment amount + change can be fully funded using one of the 0.001BIT inputs.
