...
"""Verify that starting bit with -h works as expected."""

from test_framework.test_framework import BitTestFramework
from test_framework.util import assert_equal

class HelpTest(BitTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bit with -h for help text")
        ...
        self.log.info("Start bit with -version for version information")
        ...
        self.log.info("Start bitd with -fakearg to make sure it does not start")
