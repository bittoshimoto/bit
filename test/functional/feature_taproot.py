...
def spenders_taproot_active():
    ...
    # == Test case for https://github.com/bit/bit/issues/24765 ==
...
class TaprootTest(BitTestFramework):
    ...
    def test_spenders(self, node, spenders, input_counts):
        ...
        while left:
            ...
            fee = min(random.randrange(MIN_FEE * 2, MIN_FEE * 4), amount - DUST_LIMIT)  # 10000-20000 tos fee
            in_value = amount - fee
