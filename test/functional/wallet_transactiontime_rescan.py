...
class TransactionTimeRescanTest(BitTestFramework):
    ...
    def run_test(self):
        ...
        # generate some bit to create transactions and check blockcount
        ...
        # send 10 bit to user's first watch-only address
        self.log.info('Send 10 bit to user')
        ...
        # send 5 bit to our second watch-only address
        self.log.info('Send 5 bit to user')
        ...
        # send 1 bit to our third watch-only address
        self.log.info('Send 1 bit to user')
