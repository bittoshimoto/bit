...
class SegWitTest(BitTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older bitd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let bitd fill it in.
