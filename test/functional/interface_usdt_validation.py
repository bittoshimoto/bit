...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/bit/bit/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(BitTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/bit/bit/blob/master/doc/tracing.md#tracepoint-validationblock_connected
