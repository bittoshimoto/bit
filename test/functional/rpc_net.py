...
class NetTest(BitTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=20972)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 20972)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=20972), {"success": False})
