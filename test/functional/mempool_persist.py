...
By default, bitd will dump mempool on shutdown and
...
class MempoolPersistTest(BitTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitd from writing mempool.dat to disk. Verify that `savemempool` fails")
