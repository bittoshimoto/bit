...
#ifndef BIT_NODE_CONNECTION_TYPES_H
#define BIT_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bit-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Bit’s Peer-to-Peer Network")
...
#endif // BIT_NODE_CONNECTION_TYPES_H
