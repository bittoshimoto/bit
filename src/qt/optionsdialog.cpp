      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitAtStartup);
    ...
    ui->bitAtStartup->setToolTip(ui->bitAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitAtStartup->setText(ui->bitAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitConfButton->setToolTip(ui->openBitConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitConfButton_clicked()
{
