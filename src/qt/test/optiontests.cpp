...
{
    // Test regression https://github.com/bit/bit/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bit-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bit-core/gui/pull/568.
    // With fListen=false in ~/.config/Bit/Bit-Qt.conf and all else left as default,
    // bit-qt should set both -listen and -listenonion to false and start successfully.
