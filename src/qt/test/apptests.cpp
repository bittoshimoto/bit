...
//! Entry point for BitApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitGUI tests.
void AppTests::guiTests(BitGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitGUI::consoleShown, this, &AppTests::consoleTests);
