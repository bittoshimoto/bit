...
#ifndef BIT_QT_GUIUTIL_H
#define BIT_QT_GUIUTIL_H
...
/** Utility functions used by the Bit Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bit:" URI into recipient object, return true on successful parsing
