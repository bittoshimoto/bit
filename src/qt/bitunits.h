...
#ifndef BIT_QT_BITUNITS_H
#define BIT_QT_BITUNITS_H
...
/** Bit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitUnits(QObject *parent);
