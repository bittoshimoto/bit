...
{
    BOOST_CHECK(TestSplitHost("www.bitcore.org", "www.bitcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bitcore.org]", "www.bitcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bitcore.org:80", "www.bitcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcore.org]:80", "www.bitcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:20972", "127.0.0.1", 20972));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:20972", "127.0.0.1", 20972));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:20972", "::ffff:127.0.0.1", 20972));
    BOOST_CHECK(TestSplitHost("[::]:20972", "::", 20972));
    BOOST_CHECK(TestSplitHost("::20972", "::20972", 0));
    BOOST_CHECK(TestSplitHost(":20972", "", 20972));
    BOOST_CHECK(TestSplitHost("[]:20972", "", 20972));
    ...
    BOOST_CHECK(TestSplitHost("www.bitcore.org:65536", "www.bitcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcore.org:0", "www.bitcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcore.org:", "www.bitcore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:20972", "127.0.0.1:20972"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:20972", "[::]:20972"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
