...
#ifndef BIT_TEST_SCRIPTNUM10_H
#define BIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bit Core 0.10.0, for cross-comparison.
 */
public:
