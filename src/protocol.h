...
#ifndef BIT_PROTOCOL_H
#define BIT_PROTOCOL_H
...
/**
 * Bit protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Bit Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Bit Core nodes used to support this by default, without advertising this bit,
    ...
    // bit-development mailing list. Remember that service bits are just
