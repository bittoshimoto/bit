...
#ifndef BIT_CRYPTO_CHACHA_POLY_AEAD_H
#define BIT_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bit.
 *
 ...
 *
 * The chacha20-poly1305@bit combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bit cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bit are relatively fast in
...
#endif // BIT_CRYPTO_CHACHA_POLY_AEAD_H
