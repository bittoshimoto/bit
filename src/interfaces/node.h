...
#ifndef BIT_INTERFACES_NODE_H
#define BIT_INTERFACES_NODE_H
...
//! Top-level interface for a bit node (bitd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or bit.conf.
