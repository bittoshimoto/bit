...
#ifndef BIT_SCRIPT_STANDARD_H
#define BIT_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bit address
 */
...
/**
 * Generate a Bit scriptPubKey for the given CTxDestination. Returns a P2PKH
