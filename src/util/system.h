 ...
 */
#ifndef BIT_UTIL_SYSTEM_H
#define BIT_UTIL_SYSTEM_H
...
extern const char * const BIT_CONF_FILENAME;
extern const char * const BIT_SETTINGS_FILENAME;
