...
#ifndef BIT_UTIL_SYSCALL_SANDBOX_H
#define BIT_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during bitd initialization if Bit Core was compiled
...
#endif // BIT_UTIL_SYSCALL_SANDBOX_H
