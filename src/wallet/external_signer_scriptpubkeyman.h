...
#ifndef BIT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BIT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BIT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
