...
#ifndef BIT_WALLET_WALLET_H
#define BIT_WALLET_WALLET_H
...
static const CAmount DEFAULT_CONSOLIDATE_FEERATE{10000}; // 10 tos/vbyte
/**
...
static const unsigned int DEFAULT_TX_CONFIRM_TARGET = 12;
//! -walletrbf default
...
//! Discourage users to set fees higher than this amount (in toshis) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in toshis)
...
public:
    ...
    /** Absolute maximum transaction fee (in toshis) used by default for the wallet */
