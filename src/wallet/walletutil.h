...
#ifndef BIT_WALLET_WALLETUTIL_H
#define BIT_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bit from opening the wallet, thinking it was newly created, and
