...
#ifndef BIT_WALLET_SCRIPTPUBKEYMAN_H
#define BIT_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Bit Core wallet was originally a collection of unrelated private
...
#endif // BIT_WALLET_SCRIPTPUBKEYMAN_H
