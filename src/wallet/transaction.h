...
#ifndef BIT_WALLET_TRANSACTION_H
#define BIT_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bit node, and set to 0 for transactions that were created
...
#endif // BIT_WALLET_TRANSACTION_H
