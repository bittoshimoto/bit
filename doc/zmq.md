...
The ZeroMQ feature in Bit Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ bitd -zmqpubhashtx=tcp://127.0.0.1:220971 \
               -zmqpubhashtx=tcp://192.168.1.2:220971 \
               -zmqpubhashblock="tcp://[::1]:220972" \
...
terminator). These options can also be provided in bit.conf.
