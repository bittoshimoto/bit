Bit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bit/files/Bit/bit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bit
...
New/changed settings (command-line or bit.conf file)
--------------------------------------------------------
