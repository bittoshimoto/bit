...
Bit Core version 0.19.1 is now available from:

  <https://bitcoincore.org/bin/bit-core-0.19.1/>
...
From Bit Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bit Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bit Core does not yet change appearance when
...
- #17488 fix "bitd already running" warnings on macOS (fanquake)
