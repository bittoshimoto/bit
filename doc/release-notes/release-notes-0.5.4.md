Bit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bit/files/Bit/bit-0.5.4/
...
http://gitorious.org/bit/bitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bit-Qt notifications under Growl 1.3.
Increase required age of Bit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBit properly when installing Bit-Qt over it. (Windows)
