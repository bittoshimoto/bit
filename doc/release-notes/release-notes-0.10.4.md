Bit Core version 0.10.4 is now available from:

  <https://bit.org/bin/bit-core-0.10.4/>
...
- #6953 `43c2789` Split bit-tx into its own package
- #6953 `dfe0d4d` Include bit-tx binary on Debian/Ubuntu
