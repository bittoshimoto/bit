Download URL: https://sourceforge.net/projects/bit/files/Bit/bit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BIT fee schedule (users still pay 0.01 BIT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bit00 - #bit99
