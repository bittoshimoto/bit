Bit Core version 0.9.4 is now available from:

  https://bit.org/bin/0.9.4/
...
this update is incompatible with the Bit system and could lead to consensus
forks.

Bit Core released binaries from https://bit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bit/+archive/ubuntu/bit
- A third-party or self-compiled Bit Core

upgrade to Bit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
