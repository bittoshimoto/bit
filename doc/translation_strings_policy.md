...
This document provides guidelines for internationalization of the Bit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bit_en.ts` remains unchanged.
