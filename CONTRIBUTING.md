...
First, in terms of structure, there is no particular concept of "Bit Core
...
Before you start contributing, familiarize yourself with the Bit Core build
system and tests. Refer to the documentation in the repository on how to build
Bit Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/bit/bit/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/bit/bit/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Bit Core PR Review Club](https://bitcore.reviews/) meeting.
...
Most communication about Bit Core development happens on IRC, in the
`#bit-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#bit-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/bit-core-dev/](https://www.erisian.com.au/bit-core-dev/)
and [https://gnusha.org/bit-core-dev/](https://gnusha.org/bit-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/bit-dev)
...
For GUI-related issues or pull requests, the https://github.com/bit-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/bit/bit node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bit-qt
...
fork of Bit Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/bit/bit/blob/master/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/bit/bit  # Fetch the latest upstream commit
...
The following applies to code changes to the Bit Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bit
...
https://github.com/bit/bit/pull/16189).

Also see the [backport.py script](
https://github.com/bit-core/bit-maintainer-tools#backport).
